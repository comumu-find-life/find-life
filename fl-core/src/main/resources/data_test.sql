...
-- 홈 생성 및 홈 주소 지정
insert into home(user_id, home_address_id, bath_room_count, people_count, bond, short_introduce, introduce, bill, view_count, type, deal_savable)
values
    ('1', '1', 10, 10, 20000, '짧은 소개1', '소개글1', 3000000, 10, 'RENT', 0),
    ('1', '2', 8, 8, 15000, '짧은 소개2', '소개글2', 2500000, 8, 'RENT', 0),
    ('1', '3', 12, 12, 25000, '짧은 소개3', '소개글3', 3500000, 12, 'RENT', 0),
    ('1', '4', 10, 10, 20000, '짧은 소개4', '소개글4', 3000000, 10, 'RENT', 0),
    ('1', '5', 8, 8, 15000, '짧은 소개5', '소개글5', 2500000, 8, 'RENT', 0),
    ('1', '6', 12, 12, 25000, '짧은 소개6', '소개글6', 3500000, 12, 'RENT', 0),
    ('1', '7', 10, 10, 20000, '짧은 소개7', '소개글7', 3000000, 10, 'RENT', 0),
    ('1', '8', 8, 8, 15000, '짧은 소개8', '소개글8', 2500000, 8, 'RENT', 0),
    ('1', '9', 12, 12, 25000, '짧은 소개9', '소개글9', 3500000, 12, 'RENT', 0),
    ('1', '10', 10, 10, 20000, '짧은 소개10', '소개글10', 3000000, 10, 'RENT', 0),
    ('1', '11', 8, 8, 15000, '짧은 소개11', '소개글11', 2500000, 8, 'RENT', 0),
    ('1', '12', 12, 12, 25000, '짧은 소개12', '소개글12', 3500000, 12, 'RENT', 0),
    ('1', '13', 10, 10, 20000, '짧은 소개13', '소개글13', 3000000, 10, 'RENT', 0),
    ('1', '14', 8, 8, 15000, '짧은 소개14', '소개글14', 2500000, 8, 'RENT', 0),
    ('1', '15', 12, 12, 25000, '짧은 소개15', '소개글15', 3500000, 12, 'RENT', 0);
